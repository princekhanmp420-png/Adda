module.exports = {
  ...
  onChat: async function ({ api, event }) {
    ...
    const replyList = {
      "": "🎩 আপনি সভাপতিকে মেনশন করেছেন — তিনি এখন ব্যস্ত আছেন 😇",
      "": "💬 আপনি গ্রুপ লিডার ১ কে মেনশন করেছেন — তিনি কিছুক্ষণের মধ্যে রিপ্লাই দিবেন 🖤",
      "": "🌸 আপনি গ্রুপ লিডার ২ কে মেনশন করেছেন — তিনি এখন অফলাইনে আছেন 💤",
